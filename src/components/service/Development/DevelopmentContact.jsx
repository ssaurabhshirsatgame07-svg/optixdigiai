...
const DevelopmentContact = () => {
  ...
  return (
    <section className="relative bg-[#5d00c3] py-20 px-6 md:px-12 rounded-md shadow-lg overflow-hidden m-4 new-font">
      ...
      <div className="relative max-w-7xl mx-auto text-center flex flex-col items-center justify-center space-y-6 z-10">
        ...
        <p className="text-gray-300/90 text-base md:text-lg max-w-2xl">
        ...
        <MotionLink
          ...
          whileTap={{ scale: 0.95 }}
          className="mt-4 inline-flex items-center bg-yellow-400 text-[#5d00c3] font-semibold px-6 py-3 rounded-lg shadow-lg transition-colors duration-300"
        >
          <motion.span
...
export default memo(DevelopmentContact);
