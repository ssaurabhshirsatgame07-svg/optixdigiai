...
import diva2 from "../../assets/diva2.png";
import diva3 from "../../assets/diva3.png";
import diva4 from "../../assets/diva5.png";

const images = [diva, diva2, diva3, diva4];
      ...
      >
        ...
        <div className="p-5 text-center">
          ...
          <p className="text-gray-600 text-base mb-4">
            Embrace the essence of elegance with{" "}
            <span className="font-medium text-[#5d00c3]"> DIVATHELUXE</span> a
            lifestyle e-commerce destination celebrating contemporary women’s
            fashion. Discover beautifully crafted sarees, kurtis, and apparel
            that blend timeless tradition with modern sophistication.
          </p>

          <a
            href="https://divatheluxe.com/"
            target="_blank"
